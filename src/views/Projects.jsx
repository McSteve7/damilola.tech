...
const Projects = ({ children, offset }) => (
  <>
    <DividerMiddle
      bg="linear-gradient(to right, SlateBlue 0%, black 100%)"
      speed={-0.2}
      offset={`${offset}.1`}
      factor={2}
    />
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      ...
      <UpDownWide>
        ...
        <SVG icon="circle" width={6} fill={colors.white} left="70%" top="90%" />
        <SVG icon="triangle" hiddenMobile width={16} stroke={colors.white} left="18%" top="75%" />
      ...
      <SVG icon="box" width={12} fill={colors.white} left="29%" top="26%" />
      <SVG icon="hexa" width={16} stroke={colors.white} left="75%" top="30%" />
